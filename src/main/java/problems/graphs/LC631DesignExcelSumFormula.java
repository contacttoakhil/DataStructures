 ...
 *
 */
public class LC631DesignExcelSumFormula {
    Formula[][] Formulas;
    class Formula {
    ...
    public LC631DesignExcelSumFormula(int H, char W) {
    ...
    public static void main(String[] args) {
        LC631DesignExcelSumFormula excelSumFormula = new LC631DesignExcelSumFormula(3,'C');
        excelSumFormula.set(1,'A', 2);
        excelSumFormula.sum(3, 'C', new String[]{"A1", "A1:B2"});
        excelSumFormula.set(2, 'B', 2);
        for (Formula[] formula : excelSumFormula.Formulas) {
