 ...
 */
public class LC1096BraceExpressionII {
    ...
    public static void main(String[] args) {
        LC1096BraceExpressionII braceExpressionII = new LC1096BraceExpressionII();
        //System.out.println(braceExpressionII.braceExpansionII("{a,b}{c,{d,e}}")); // ["ac","ad","ae","bc","bd","be"]
        System.out.println(braceExpressionII.braceExpansionII("{{a,z},a{b,c},{ab,z}}")); // ["a","ab","ac","z"]
    }
}
