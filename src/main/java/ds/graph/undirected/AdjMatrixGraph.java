...
/**
 * We can represent a graph (undirected or directed) using adjacency list or matrix. This class implements the later for undirected graph.
 */
public class AdjMatrixGraph implements IUndirectedGraph {
