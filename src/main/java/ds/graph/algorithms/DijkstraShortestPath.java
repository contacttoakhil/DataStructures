 ...
 *
 * This algorithm uses the greedy approach and always picks up the children closest vertex to the source by making use of priority queue. If we insert the adjacent vertices of vertex r into priority queue and then pick the minimum element from this then it
